...
namespace BFWProjectAuditLib {
    
    
    [System.Runtime.InteropServices.ComVisible(false)]
    public partial class ExecuteActivity : System.Activities.Activity, System.ComponentModel.ISupportInitialize {
...
partial void AfterInitializeComponent();
        ...
        public void InitializeComponent() {
            ...
            System.IO.Stream initializeXaml = typeof(ExecuteActivity).Assembly.GetManifestResourceStream(resourceName);
            ...
            try {
                ...
                writerSettings.AccessLevel = System.Xaml.Permissions.XamlAccessLevel.PrivateAccessTo(typeof(ExecuteActivity));
        ...
        private string FindResource() {
            string[] resources = typeof(ExecuteActivity).Assembly.GetManifestResourceNames();
            for (int i = 0; (i < resources.Length); i = (i + 1)) {
                string resource = resources[i];
                if ((resource.Contains(".ExecuteActivity.g.xaml") || resource.Equals("ExecuteActivity.g.xaml"))) {
                    return resource;
                }
            }
